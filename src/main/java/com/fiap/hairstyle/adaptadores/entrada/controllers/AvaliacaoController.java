...
public class AvaliacaoController {
    ...
    @Operation(summary = "Avaliar profissional", description = "Permite ao cliente avaliar um profissional após o agendamento.")
    @ApiResponses({
    ...
    @Operation(summary = "Avaliar estabelecimento", description = "Permite ao cliente avaliar o estabelecimento após o agendamento.")
    @ApiResponses({
    ...
    @Operation(summary = "Listar avaliações de um profissional", description = "Retorna uma lista de todas as avaliações de um profissional específico.")
    ...
    @Operation(summary = "Listar avaliações de um estabelecimento", description = "Retorna uma lista de todas as avaliações de um estabelecimento específico.")
