...
public class UsuarioController {
    ...
    @Operation(summary = "Buscar um usuário pelo ID", description = "Busca um usuário específico pelo seu ID.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Criar novo usuário", description = "Cria um novo usuário no sistema. Verifica se o username já existe antes de cadastrar.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualizar usuário existente", description = "Atualiza os dados de um usuário específico, incluindo nome de usuário, senha e papel (role).")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Deletar usuário pelo ID", description = "Exclui um usuário do sistema com base em seu ID.")
    @ApiResponses(value = {
